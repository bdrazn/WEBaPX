        ...
        <div class="main"><br />
          <div class="wrapper1">
            ...
            <div class="main_content">
              ...
              <div class="info header div-content " style="float: left; margin: 2%; width: 45%; height:auto; background-color:#f8f8f8; border-style:double;">

                <br>
                <h6><strong>
                    <pre> FIND PART  </pre>
                  </strong></h6>
                <form name="search" class="info" target="" action="findpart_result.php" onsubmit="return myFunction()" method="POST" target="findpart_result.php"><br>
