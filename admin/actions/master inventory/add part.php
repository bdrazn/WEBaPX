          ...
          <div class="wrapper1">
            ...
            <div class="main_content">
              ...
              <div class="content wrapper1 ">
                ...
                <div class="info header div-content  clearfix " style="float: left;  min-width:500px; height: 100%; background-color:#f8f8f8; border-style:double;">
                  <br>
                  <h6><strong>
                      <pre> ADD NEW PART  </pre>
                    </strong></h6>

                  <form name="newPart" action="addpartconn.php" method="POST" onsubmit="return myFunction()" style="margin:5% ;">
                    <label style="text-align:left;"> Part ID : </label>
                    <input type="text" id="partid" name="partid" required /><br><br>

              
                    <label style="text-align:left;"> Part Type : </label>
                    <input type="text" id="parttype" name="parttype"></input> <br><br>

                    <label style="text-align:left;"> car Type : </label>
                    <input type="text" id="partname" name="cartype"></input> <br><br><hr>
