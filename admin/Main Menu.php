        ...
        <div id="content">
          <div class="main">
            <div class="wrapper1">
              ...
              <div class="main_content">
                <div class="header div-content">
                  <h5><strong> Welcome <a href="Announcements.php" style="float: right;" > ANNOUNCEMENTS </a></strong></h5>
                </div>
           ...
           <section style="margin:5%"> 
            ...
            <p><li>CARRRRSSS! Assemble!!  HAHOOO!!!</li></p>
            <p><li><p>Lets be awesome today!</p> </li>
            </p>
