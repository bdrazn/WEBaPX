            ...
            <div class="wrapper1"><br />
              ...
              <div class="main_content" >
                <div class="header div-content ">
                  <h5><strong>Master Inventory Management</strong></h5>
                </div>
                <div class="info" >
                  ...
                  <div class="header textLink" class="bgcol">
                      ...
                      <li >
                        <a href="actions/master inventory/add part.php"> <i>  >   Add new car part </i></p></a>
                      </li>
                      <hr />

                                      
                      <li>
                        <a href="actions/master inventory/remove device.php"> <i> > Remove part from inventory</i></a><hr />
                      </li>
                      <li>
                        <a href="actions/master inventory/findpart.php"> <i> > Find part</i></a>
                      </li>
                      <hr />

                      <a href="actions/master inventory/allpart.php" style="float:left"
                        ><li><i> > Display all parts</i></li></a
                      ><br />
